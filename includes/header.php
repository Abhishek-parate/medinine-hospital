...
<head>
    ...
    <meta name="geo.position" content="21.1014517;79.1018804">
    <meta name="ICBM" content="21.1014517, 79.1018804">
    ...
    <meta name="twitter:site" content="@MedinineHospital">
    ...
    <link rel="apple-touch-icon" href="/assets/medinine.png">
...
<body class="bg-gray-50">
    ...
    <header class="bg-white shadow-lg sticky top-0 z-50">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden lg:flex space-x-8">
                    <a href="/index.php" class="<?php echo ($current_page == '' || $current_page == 'index') ? 'text-primary font-semibold' : 'text-gray-700 hover:text-primary'; ?> transition duration-300 flex items-center space-x-1">
                        <i class="fas fa-home"></i>
                        <span>Home</span>
                    </a>
                    <a href="/about-medinine-hospital-nagpur.php" class="<?php echo (strpos($current_page, 'about') !== false) ? 'text-primary font-semibold' : 'text-gray-700 hover:text-primary'; ?> transition duration-300 flex items-center space-x-1">
                        <i class="fas fa-info-circle"></i>
                        <span>About</span>
                    </a>
                    <div class="relative group">
                        <a href="/medical-services-nagpur.php" class="<?php echo (strpos($current_page, 'service') !== false || strpos($current_page, 'medical') !== false) ? 'text-primary font-semibold' : 'text-gray-700 hover:text-primary'; ?> transition duration-300 flex items-center space-x-1">
                        ...
                        <div class="absolute left-0 mt-2 w-80 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                            <div class="p-4 grid grid-cols-2 gap-2">
                                <a href="/emergency-trauma-care-nagpur.php" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                                    <i class="fas fa-ambulance text-accent mr-2"></i>Emergency & Trauma
                                </a>
                                <a href="/surgery-services-nagpur.php" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                                    <i class="fas fa-cut text-primary mr-2"></i>Surgery Services
                                </a>
                                <a href="/maternity-gynecology-nagpur.php" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                                    <i class="fas fa-baby text-pink-500 mr-2"></i>Maternity Care
                                </a>
                                <a href="/icu-critical-care-nagpur.php" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                                    <i class="fas fa-heartbeat text-gold mr-2"></i>ICU Services
                                </a>
                                <a href="/kidney-dialysis-treatment-nagpur.php" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                                    <i class="fas fa-kidneys text-green-500 mr-2"></i>Dialysis Center
                                </a>
                                <a href="/diagnostic-imaging-services-nagpur.php" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                                    <i class="fas fa-x-ray text-purple-500 mr-2"></i>Diagnostic Services
                                </a>
                            </div>
                        </div>
                    </div>
                    <a href="/doctors-specialists-nagpur.php" class="<?php echo (strpos($current_page, 'doctor') !== false) ? 'text-primary font-semibold' : 'text-gray-700 hover:text-primary'; ?> transition duration-300 flex items-center space-x-1">
                        <i class="fas fa-user-md"></i>
                        <span>Doctors</span>
                    </a>
                    <a href="/contact-hospital-nagpur.php" class="<?php echo (strpos($current_page, 'contact') !== false) ? 'text-primary font-semibold' : 'text-gray-700 hover:text-primary'; ?> transition duration-300 flex items-center space-x-1">
                ...
                <div class="flex items-center space-x-2">
                    <a href="/appointment-booking-online.php" class="hidden md:flex bg-primary text-white px-4 py-2 rounded-lg font-semibold hover:bg-primaryDark transition duration-300 items-center space-x-2 text-sm">
        ...
        <div id="mobileMenu" class="lg:hidden bg-white border-t border-gray-200 hidden">
            <div class="container mx-auto px-4 py-4">
                <nav class="space-y-4">
                    <a href="/index.php" class="block text-gray-700 hover:text-primary transition duration-300">
                        <i class="fas fa-home mr-2"></i> Home
                    </a>
                    <a href="/about-medinine-hospital-nagpur.php" class="block text-gray-700 hover:text-primary transition duration-300">
                        <i class="fas fa-info-circle mr-2"></i> About Us
                    </a>
                    <a href="/medical-services-nagpur.php" class="block text-gray-700 hover:text-primary transition duration-300">
                        <i class="fas fa-stethoscope mr-2"></i> Our Services
                    </a>
                    <a href="/doctors-specialists-nagpur.php" class="block text-gray-700 hover:text-primary transition duration-300">
                        <i class="fas fa-user-md mr-2"></i> Our Doctors
                    </a>
                    <a href="/contact-hospital-nagpur.php" class="block text-gray-700 hover:text-primary transition duration-300">
                        <i class="fas fa-phone mr-2"></i> Contact Us
                    </a>
                    <a href="/appointment-booking-online.php" class="block bg-primary text-white px-4 py-2 rounded-lg font-semibold text-center">
