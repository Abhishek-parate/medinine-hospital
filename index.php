...
$page_description = "Medinine Hospital - Leading super-speciality hospital in Nagpur offering advanced medical care, 24/7 emergency services, expert doctors, state-of-the-art facilities, trauma care, surgery, maternity services, and dialysis center. Call 8668289254 for emergency services.";
$page_keywords = "best hospital Nagpur, super speciality hospital Nagpur, emergency services Nagpur, trauma care Nagpur, surgery hospital Nagpur, maternity services Nagpur, dialysis center Nagpur, ICU facilities Nagpur, 24/7 hospital Nagpur, ambulance services Nagpur, Medinine Hospital, healthcare Nagpur, medical services Nagpur";
$canonical_url = "https://medininehospital.com/";
$og_title = "Best Super-Speciality Hospital in Nagpur - Medinine Hospital";
$og_description = "Leading healthcare provider in Nagpur offering comprehensive medical services including trauma care, surgery, maternity services, ICU care, dialysis, and 24/7 emergency services at Parivartan Square, Besa Road, Manewada.";
    ...
    <div class="gradient-primary py-20 lg:py-28">
        ...
        <div class="relative container mx-auto px-4 text-center text-white">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed opacity-90">
                ...
                Your health is our priority at Medinine Hospital, Besa Road, Manewada, Nagpur.
            </p>
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-12">
                ...
                <a href="/appointment-booking-online.php" class="bg-white text-primary hover:bg-gray-100 px-8 py-4 rounded-lg text-lg font-semibold transition duration-300 flex items-center justify-center space-x-2 shadow-lg">
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">Comprehensive healthcare services with advanced medical technology and compassionate care for all your health needs in Nagpur.</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 border-t-4 border-accent service-card">
                ...
                <p class="text-gray-600 mb-6 leading-relaxed">24/7 emergency services with specialized trauma care, fracture treatment, and spine surgery. Our emergency department is equipped with modern life-saving equipment and staffed by experienced emergency medicine specialists.</p>
            ...
            <div class="group bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 border-t-4 border-primary service-card">
                <div class="flex items-center mb-6">
                    ...
                    <h3 class="text-xl font-semibold text-secondary">Advanced Surgery Services</h3>
                </div>
                <p class="text-gray-600 mb-6 leading-relaxed">General surgery and minimally invasive laparoscopic procedures performed by expert surgeons using cutting-edge technology for faster recovery and minimal scarring.</p>
                <div class="flex items-center justify-between">
            ...
            <div class="group bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 border-t-4 border-pink-500 service-card">
                ...
                <p class="text-gray-600 mb-6 leading-relaxed">Comprehensive women's healthcare including maternity services, gynecological treatments, and infertility solutions with experienced specialists and modern delivery rooms.</p>
                <div class="flex items-center justify-between">
            ...
            <div class="group bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 border-t-4 border-gold service-card">
                ...
                <p class="text-gray-600 mb-6 leading-relaxed">State-of-the-art intensive care unit with advanced monitoring systems and experienced critical care specialists providing round-the-clock care for critically ill patients.</p>
                <div class="flex items-center justify-between">
            ...
            <div class="group bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 border-t-4 border-green-500 service-card">
                ...
                <p class="text-gray-600 mb-6 leading-relaxed">Complete kidney disease diagnosis and treatment with state-of-the-art dialysis facilities managed by experienced nephrologists and trained dialysis technicians.</p>
                <div class="flex items-center justify-between">
            ...
            <div class="group bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 border-t-4 border-purple-500 service-card">
                ...
                <p class="text-gray-600 mb-6 leading-relaxed">Advanced diagnostic facilities including digital X-ray, ultrasound, and comprehensive blood testing services for accurate diagnosis and treatment planning.</p>
                <div class="flex items-center justify-between">
        ...
        <div class="text-center mt-12">
            <a href="/medical-services-nagpur.php" class="bg-primary text-white px-8 py-4 rounded-lg font-semibold hover:bg-primaryDark transition duration-300 inline-flex items-center space-x-2">
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center group card">
                ...
                <p class="text-gray-600">Round-the-clock emergency care with ambulance services available for immediate medical assistance and critical care in Nagpur.</p>
            </div>
            ...
            <div class="text-center group card">
                ...
                <p class="text-gray-600">Highly qualified and experienced doctors across all specialties providing world-class medical care and treatment with compassionate approach.</p>
            </div>
            ...
            <div class="text-center group card">
                ...
                <p class="text-gray-600">State-of-the-art medical equipment, modern operation theaters, ICU facilities, and comfortable patient rooms with latest amenities.</p>
            </div>
            ...
            <div class="text-center group card">
                ...
                <p class="text-gray-600">Patient-centered approach with personalized treatment plans and emotional support throughout the healing journey with dedicated nursing staff.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600">Take a look at our modern facilities and advanced medical equipment at Parivartan Square, Nagpur</p>
        </div>
        
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="relative overflow-hidden rounded-xl shadow-lg group">
                <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Medinine Hospital Exterior - Best Hospital in Nagpur" class="w-full h-64 object-cover group-hover:scale-110 transition duration-500">
            ...
            <div class="relative overflow-hidden rounded-xl shadow-lg group">
                <img src="https://images.unsplash.com/photo-1563213126-a4273aed2016?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="ICU Ward - Critical Care Unit at Medinine Hospital" class="w-full h-64 object-cover group-hover:scale-110 transition duration-500">
                <div class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-300">
                    <div class="absolute bottom-4 left-4 text-white">
            ...
            <div class="relative overflow-hidden rounded-xl shadow-lg group">
                <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Operation Theater - Advanced Surgery Suite at Medinine Hospital" class="w-full h-64 object-cover group-hover:scale-110 transition duration-500">
                <div class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-300">
                    <div class="absolute bottom-4 left-4 text-white">
...
<section class="py-16 bg-primary text-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-xl opacity-90">Real experiences from our satisfied patients in Nagpur</p>
        </div>
        
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white bg-opacity-10 p-8 rounded-xl backdrop-blur-sm card">
                ...
                <p class="text-lg mb-6 leading-relaxed">"Excellent medical care and very professional staff. The emergency team at Medinine Hospital saved my life during a critical situation. Highly recommended hospital in Nagpur!"</p>
            ...
            <div class="bg-white bg-opacity-10 p-8 rounded-xl backdrop-blur-sm card">
                ...
                <p class="text-lg mb-6 leading-relaxed">"Safe delivery of my baby with excellent maternity care. The doctors and nurses were very caring and supportive throughout my pregnancy and delivery."</p>
                <div class="flex items-center">
                    <div class="w-12 h-12 bg-gold rounded-full flex items-center justify-center mr-4">
                        <i class="fas fa-user text-white"></i>
                    </div>
            ...
            <div class="bg-white bg-opacity-10 p-8 rounded-xl backdrop-blur-sm card">
                ...
                <p class="text-lg mb-6 leading-relaxed">"Successful laparoscopic surgery with minimal recovery time. The surgical team was highly skilled and the post-operative care was exceptional at Medinine Hospital."</p>
                <div class="flex items-center">
                    <div class="w-12 h-12 bg-gold rounded-full flex items-center justify-center mr-4">
                        <i class="fas fa-user text-white"></i>
                    </div>
...
<section class="py-16 bg-secondary text-white">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl mb-8 max-w-3xl mx-auto">Our medical team is ready to provide you with the best possible care. Contact us for appointments or emergency services at our Parivartan Square location in Nagpur.</p>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-4xl md:text-5xl font-bold text-secondary mb-4">Visit Our Hospital</h2>
            <p class="text-lg text-gray-600">Conveniently located at Parivartan Square, Besa Road, Manewada, Nagpur</p>
        </div>
        
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                <h3 class="text-2xl font-bold text-secondary mb-6">Location & Contact Details</h3>
                <div class="space-y-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-800 mb-1">Hospital Address</h4>
                            <p class="text-gray-600">1A/1, Parivartan Square, Besa Road, Manewada, Nagpur, Maharashtra 440037</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">24/7 Emergency: <a href="tel:8668289254" class="text-accent font-semibold">8668289254</a></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600"><a href="mailto:info@medininehospital.com" class="text-green-600">info@medininehospital.com</a></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-800 mb-1">Operating Hours</h4>
                            <p class="text-gray-600">24/7 Emergency Services Available<br>OPD: 8:00 AM - 8:00 PM</p>
                        </div>
                    </div>
                </div>
                
                <div class="mt-8">
                    <a href="https://maps.app.goo.gl/1yM8B1obgk8BwBzV9" target="_blank" class="bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primaryDark transition duration-300 inline-flex items-center space-x-2">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg">
                <iframe 
                    ...
                    title="Medinine Hospital Location - Best Hospital in Nagpur">
                </iframe>
            </div>
        </div>
    </div>
